...
class StateWiseCases extends Component {
    ...
    return (
      <>
        <div className="state__row">
          <h1 className="state__title">{nameOfState}</h1>
          <div className="tests__container">
            <p className="test__title">Tested</p>
            <p className="test">{totalTestedData}</p>
          </div>
        </div>

        <div>
          <p className="last__date">{`last update on ${date}`}</p>
        </div>

        <div className="align__center__row">
        ...
        <div className="total__district__data__block">
          <h1 className={`district__heading ${category}__color`}>
            Top Districts
          </h1>
          <div className="ul__parent__list">
            <div className="district__data__ul__list">
              <ul
                className="districts__container"
          ...
          <div className="graphs__data" testid="lineChartsContainer">
  ...
  render() {
    ...
    return (
      <>
        <Header />
        <div className="state__main__container">
          <div className="state__content__container">
